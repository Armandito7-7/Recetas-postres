...
<div class="login-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg"><b><?php echo $nombre.' '.$ap_p.' '.$ap_m ?></b> Inserte la nueva foto que quiere cambiar.</p>
      <form action="<?php echo base_url().'/admin/perfil/editar/actualizarfoto/'.$id?>" method="post" enctype="multipart/form-data">
      <?= csrf_field() ?>  
      ...
      <p class="mt-3 mb-1">
        <a href="<?php echo base_url('/admin')?>">Cancelar</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
