            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                <div class="card-header text-muted border-bottom-0">
                  ID   <?php echo $key->id_usuario?>
                </div>
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b><?php echo $key->nombre_usuario.' '.$key->ap_paterno_usuario.' '.$key->ap_materno_usuario?></b></h2>
                      <p class="text-muted text-sm"><b> <?php echo (($key->rol_usuario == 1) ?  'Administrador' :  'Usuario') ?></b></br>  <?php echo (($key->sexo_usuario == 'H') ?  'Hombre' :  'Mujer')?></p>
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-envelope"></i></span> <?php echo $key->email_usuario?></li></br>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: <?php echo $key->telefono?></li>
                      </ul>
                    </div>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <a href="<?php echo base_url().'/admin/usuarios/elimanarusu/'.$key->id_usuario;?>" class="btn btn-sm bg-red">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="<?php echo base_url().'/admin/usuarios/perfil/'.$key->id_usuario;?>" class="btn btn-sm bg-teal">
